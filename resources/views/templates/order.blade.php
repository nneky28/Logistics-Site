  ...
  <div class="row">
      <div class="col-lg-4 mb-lg-0 mb-3">
          <div class="card p-3">
              ...
              <div class="d-flex align-items-center justify-content-between"> <small><span class="fw-bold">Expiry date:</span><span>10/16</span></small> <small><span class="fw-bold">Name:</span><span>{{$data['name']}}</span></small> </div>
          </div>
      </div>
      <div class="col-lg-4 mb-lg-0 mb-3">
          <div class="card p-3">
                  ...
                  <div class="collapse p-3 pt-0" id="collapseExample">
                      <div class="row">
                          <div class="col-8">
                              ...
                              <p class="mb-0"><span class="fw-bold">Amount:</span><span class="c-green"></span></p>
                              <p class="mb-0"><span class="fw-bold">TrackID:</span><span class="c-green"></span></p>
                  ...
                  <div class="collapse show p-3 pt-0" id="collapseExample">
                      <div class="row">
                          <div class="col-lg-5 mb-lg-0 mb-3">
                              ...
                              <p class="mb-0"><span class="fw-bold">TrackID:{{$data['coupon']}}</span><span class="c-green"></span></p>
                              <p class="mb-0"><span class="fw-bold">Name:{{$data['name']}}</span><span class="c-green"></span></p>
                              <p class="mb-0"><span class="fw-bold">Email:{{$data['email']}}</span><span class="c-green"></span></p>
                              <p class="mb-0"><span class="fw-bold">Phone:{{$data['phone_number']}}</span><span class="c-green"></span></p>
                              <p class="mb-0"><span class="fw-bold">Status:{{$data['status']}}</span><span class="c-green"></span></p>
                        <p class="mb-0">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Atque nihil neque quisquam aut repellendus, dicta vero? Animi dicta cupiditate, facilis provident quibusdam ab quis, iste harum ipsum hic, nemo qui!</p>
                          </div>
                          ...
                          <div class="col-lg-7">
                              <form action="" class="form" method="POST">
                                  ...
                                  <div class="row">
                                      <div class="col-12">
                                          <div class="form__div">
                                               <input type="text" class="form-control" placeholder=" " name="number"> <label for="" class="form__label">Card Number</label> </div>
                                      </div>
                                   

                                      <div class="col-6">
                                          <div class="form__div"> 
                                              <input type="text" class="form-control" placeholder=" " name="date"> <label for="" class="form__label">MM / yy</label> </div>
                                      </div>
                                      <div class="col-6">
                                          <div class="form__div">
                                               <input type="password" class="form-control" placeholder=" " name="pwd"> <label for="" class="form__label">cvv code</label> </div>
                                      </div>
                                      <div class="col-12">
                                          <div class="form__div"> 
                                              <input type="text" class="form-control" placeholder=" " name="card"> <label for="" class="form__label">name on the card</label> </div>
                                      </div>
