            ...
            <div class="row">
               <div class="col-xl-7 col-lg-8">
                  ...
                  <div class="blog-details">
                     <img  class="blog-details-img-1" src="images/{{$item['image']}}" alt="">
                     <small class="date">{{$item['created_at']}}  -  BY Admin</small>
                     <h2 class="blog-details-title">{{$item['title']}}</h2>
                     <div class="blog-details-body">
                        <div class="blog-details-quote">{{$item['desc']}}</div>
                        <p>{{$item['title']}}</p>
                        <p>{{Str::limit($item['content'],100)}}</p>
                        <a href="/blogmore?id={{$item['id']}}">Read More</a>
                     </div>
                  </div>
                  ...
                  <div class="sidebar">
                        ...
                        <div class="popular-posts-lists ">
                           ...
                           <div class="single-popular-post">
                              ...
                              <div class="popular-post-txt">
                                 <h5 class="popular-post-title"><a href="">{{$item['title']}}...</a></h5>
                     ...
                     <div class="blog-sidebar-widgets">
                        <div class="category-lists">
                           ...
                           @foreach ($all_data as $item)
                           <ul>
                              <li class="single-category"><a href="">{{$item['categories']}}</a></li>
                              </ul>
                          @endforeach
                        </div>
                     </div>
